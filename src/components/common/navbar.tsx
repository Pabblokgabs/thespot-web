...
const NavBar: React.FC<nav> = ({ isScrolled = false, isSticky = true }) => {
	...
	return (
		<header
			...
			} z-100 opacity-100 bg-white/95 shadow-sm backdrop-blur-sm transition ease-in-out duration-500`}
		>
			<div className="container mx-auto px-4 py-4 flex items-center justify-between">
				...
				<div className="flex items-center space-x-4">
					...
					<div className="flex items-center gap-4">
						...
						<FiSearch className="text-black block md:hidden" />
						{isLoggedIn ? (
							<Dropdown
								trigger={["click"]}
								menu={{
							...
							>
								<div className="block md:flex rounded-full items-center whitespace-nowrap md:cursor-pointer">
									<IoEllipse className="text-black block md:hidden" size={30} />
